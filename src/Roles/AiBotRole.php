...
final class AiBotRole {
	...
	public static function capabilities(): array {
		return array(
			...
			'edit_published_talaxie_releases'      => true,
			'edit_others_talaxie_releases'         => true,
			'publish_talaxie_releases'             => true,
			'delete_talaxie_release'               => true,
			'delete_talaxie_releases'              => true,
			'delete_published_talaxie_releases'    => true,
			'delete_others_talaxie_releases'       => true,
			'read_private_talaxie_releases'        => true,
			'edit_talaxie_contributor'             => true,
			'edit_talaxie_contributors'            => true,
			'edit_published_talaxie_contributors'  => true,
			'read_private_talaxie_contributors'    => true,
		);
	}
